            ...
            <div class="col content-page p-5 bg-white">
                <nav aria-label="Breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Add Question Quiz</a></li>
                    </ol>
                </nav>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Add Question Quiz</h2>
                            <form action="{{ route('editor.quiz.detail.doadd') }}" id="form-data" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <select class="form-control" id="jenis" name="jenis"
                                                        ...
                                                        <option value="2" selected>Pilihan Ganda</option>
                                            ...
                                            <div class="col-md-12 isian">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pertanyaan_1" id="pertanyaan_1"
                                                        class="form-control" placeholder=""
                                            ...
                                            <div class="col-md-12 ganda">
                                                <div class="form-group">
                                                    <label for="">Pertanyaan</label>
                                                    <input type="text" name="pertanyaan_2" id="pertanyaan_2"
                                                        class="form-control" placeholder=""
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 true_or_false">
                                                <div class="form-group">
                                                    <label for="">Pertanyaan</label>
                                                    <input type="text" name="pertanyaan_3" id="pertanyaan_3"
                                                        class="form-control" placeholder=""
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bobot_nilai" id="bobot_nilai"
                                                        class="form-control" placeholder=""
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
