                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                Silahkan Unggah Template untuk Sertifikat
                            </p>
                            <form action="{{ route('editor.konten.doadd') }}" id="form-data" method="POST"
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('editor.module.detail', [$id, $materi, $module]) }}"
                            ...
                            @if (!empty($data_konten))
                                <h3>Konten Aktif</h3>
                                <img src="{{ url('/konten/' . $data_konten->file) }}" alt="" width="100%">
                            @endif
