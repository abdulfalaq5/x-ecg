...
<body>
                                    ...
                                    <nav class="navigation">
                                        <ul class="nav menu">
                                            @if (Auth::user()->level == 2)
                                                <li><a href="{{ route('editor.beranda') }}">List Courses </a></li>
                                            @else
    ...
    <section class="slider">
        <div class="hero-slider">
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image:url({{ asset('web/img/slider2.jpg') }})">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                ...
                                @if (empty(Auth::user()->name))
                                    <div class="button">
                                        <a href="#" class="btn" onclick="formRegister()">Join Now</a>
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            <!-- End Single Slider -->
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image:url('{{ asset('web/img/slider.jpg') }}')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
            ...
            <div class="row">
                @if (!empty($get_course))
                    @foreach ($get_course as $item)
                        <div class="col-lg-4 col-md-6 col-12" onclick="formLogin()">
                            <!-- Single Blog -->
                            <div class="single-news">
                                ...
                                <div class="news-body">
                                    <div class="news-content">
                                        ...
                                        @endif
                                        <p class="text">{!! batasString($item->des, 100) !!}</p>
    ...
    <section class="Feautes section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <a href="#" class="btn" onclick="formLogin()" style="color: #000000">Start
                            Learning</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content">
                        <h2>Bring Your ECG</h2>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of
                            classical Latin literature from 45 BC, making it over 2000 years old.</p>
                        <div class="button">
                            <a href="#" class="btn" onclick="formLogin()">Upload Document</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="portfolio section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Let’s Join Our Community</h2>
                        <img src="{{ asset('web/img/section-img.png') }}" alt="#">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="owl-carousel portfolio-slider">
                        <div class="single-news">
                            <div class="news-head">
                                <img class="komen" src="{{ asset('web/img/blog1.jpg') }}" alt="#">
                            </div>
                            <div class="news-body">
                                <div class="news-content">
                                    <p class="text">Lorem ipsum dolor a sit ameti, consectetur adipisicing elit, sed
                                        do
