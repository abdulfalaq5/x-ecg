            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="kategori_name" id="kategori_name" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->kategori_name }}">
...
<script>
    ...
    $("#form-data").submit(function(e) {
        ...
        ajax({
            url: "{{ route('master.kategori.update', $data->_token) }}",
            postData: postData,
            processData: false,
            contentType: false,
            alert: false,
