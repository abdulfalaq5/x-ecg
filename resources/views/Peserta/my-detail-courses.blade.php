        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
                ...
                <div class="navbar-dark bg-white position-fixed h-100 align-self-start w-sidebar">
                    ...
                    <div class="container">
                        <div class="accordion" id="faq">
                            ...
                            <div>
                                <div class="card-body">
                                    <a type="button" style="color: #000000" onclick="window.location.href='{{ route('peserta.sertifikat', $id) }}'" class="accord mb-0">Sertifikat</a>
                                </div>
                            </div>
                            @endif
                        </div>
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="row mb-5 text-center">
                    ...
                    <div class="col-2">
                        <a class="" href="{{ route('peserta.course.quiz', $id) }}">Kuis</a>
                    </div>
                </div>
                <p>{!! $data_course->des !!}</p>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card mb-3">
                                <div class="card-body d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title">Belum Ada Review di Course ini</h5>
                                    </div>
                                </div>
                            </div>
                            @else
                            <div class="card mb-3">
                                <div class="card-body d-flex">
                                    <img src="{{ asset('web/img/Avatar-review.png') }}" alt="Arlene McCoy" class="profile-pic">
                                    <div>
                                        <h5 class="card-title">Arlene McCoy</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">about an hour ago</h6>
                                        <p class="card-text">Access to IBM Cloud modelling what is I was looking
                                            for
                                            and Aaron got me the solution.</p>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <!--<div class="card mb-3">
                                <div class="card-body d-flex">
                                    <img src="{{ asset('web/img/Avatar-review.png') }}" alt="Arlene McCoy"
                                        class="profile-pic">
                                    <div>
                                        <h5 class="card-title">Arlene McCoy</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">about an hour ago</h6>
                                        <p class="card-text">Access to IBM Cloud modelling what is I was looking for
                                            and Aaron got me the solution.</p>
                                    </div>
                                </div>
                            </div>-->
                            ...
                            <!--<div class="card">
                                <div class="card-body d-flex">
                                    <img src="{{ asset('web/img/Avatar-review.png') }}" alt="Kristin Watson"
                                        class="profile-pic">
                                    <div>
                                        <h5 class="card-title">Kristin Watson</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">about an hour ago</h6>
                                        <p class="card-text">Upon completion of this ipsum dolor sit amet, consectetur
                                            adipiscing elit. Odio dictum morbi odio facilisi. At posuere purus, eget
                                            pretium sem nec feugiat.</p>
                                    </div>
                                </div>
                            </div>-->
