            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title_banner" id="title_banner" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->title_banner }}">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="des_banner" id="des_banner" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->des_banner }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <img width="250px" src="{{ url('/image/' . $data->image) }}">
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#form-data").submit(function(e) {
        ...
        if ($('#image')[0].files[0]) {
            ...
            postData.append('image', 'undifined');
        }

        ajax({
            url: "{{ route('cms.banner.update', $data->_token) }}",
            postData: postData,
            processData: false,
            contentType: false,
            alert: false,
