        ...
        <tr>
            <td align="center" valign="top" bgcolor="#F0F0F0" style="background-color: #FBFBFB;">
                ...
                <table border="0" width="600" cellpadding="0" cellspacing="0" class="container"
                    ...
                    <tr>
                        <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;background: url('#')no-repeat;background-size: 70%;background-position: center;border-bottom: solid 1em #236fb9;">
