        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="row mb-5 text-center">
                    <div class="col-2">
                        <a href="{{ route('editor.module.detail', [$id, $materi, $module]) }}">Informasi</a>
                    </div>
                    <div class="col-2">
                        <a href="{{ route('editor.konten', [$id, $materi, $module]) }}">Konten</a>
                    </div>
                    <div class="col-2 info-active">
                        <a class="" href="{{ route('editor.quiz.index', [$id, $materi, $module]) }}">Quiz</a>
                    </div>
                </div>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">List Quiz</h2>
                            <a class="btn btn-success" href="{{ route('editor.quiz.add', [$id, $materi, $module]) }}"
                                style="color: #000000">Add Quiz</a><br>
                                ...
                                @if (!empty($data_quiz))
                                    ...
                                    @foreach ($data_quiz as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['waktu_quiz'] }}</td>
                                            <td>
                                                <a href="{{ route('editor.quiz.detail', [$item['id'], $id, $materi, $module]) }}"
                                                    class="btn btn-primary" style="color: black">Detail</a>
                                                <a href="{{ route('editor.quiz.edit', [$item['id'], $id, $materi, $module]) }}"
                                                    class="btn btn-primary" style="color: black">Update</a>
                                                <a href="{{ route('editor.quiz.delete', [$item['id'], $id, $materi, $module]) }}"
