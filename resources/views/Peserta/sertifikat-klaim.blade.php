        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
            ...
            <ul class="navbar-nav d-flex flex-row me-1">
                ...
                <li class="nav-item d-flex justify-content-center align-items-center profile-header">
                    <a href="#">John </a> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
                ...
                <div class="navbar-dark bg-white position-fixed h-100 align-self-start w-sidebar">
                    <div class="col-12 mt-5 mb-3">
                        ...
                        <div class="logo d-flex justify-content-center align-items-center">
                            <a href="index.html"><img src="{{ asset('web/img/logoecg.png') }}" alt="Mobile ECG" width="150px"></a>
                        </div>
                        <!-- End Logo -->
                        <!-- Mobile Nav -->
                        ...
                        <div class="accordion" id="faq">
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead1">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq100" aria-expanded="true" aria-controls="faq100">Pre-Test</a>
                                </div>

                                <div id="faq100" class="collapse" aria-labelledby="faqhead1" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 1-->
                                        <a href="#" class="accord mb-0">Pengertian dan Manfaat EKG</a>
                                        <a href="#" class="accord mb-0">Sistem Konduksi Jantung</a>
                                        <a href="#" class="accord mb-0">Depolariasi dan Repolariasi</a>
                                        <a href="#" class="accord mb-0">Kuis</a>
                                        <!-- end collpase 1-->
                                    </div>
                                </div>
                            </div>
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead2">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq200" aria-expanded="true" aria-controls="faq200">Course 1 - Pendahuluan</a>
                                </div>

                                <div id="faq200" class="collapsed" aria-labelledby="faqhead2" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 2-->
                                        <a href="#" class="accord mb-0">Pengertian dan Manfaat EKG</a>
                                        <a href="#" class="accord mb-0">Sistem Konduksi Jantung</a>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead3">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq300" aria-expanded="true" aria-controls="faq300">Course 2 - Konsep Dasar EKG</a>
                                </div>

                                <div id="faq300" class="collapse" aria-labelledby="faqhead3" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 3-->
                                    </div>
                                </div>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead4">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq400" aria-expanded="true" aria-controls="faq400">Course 3 - Gambaran EKG</a>
                                </div>

                                <div id="faq400" class="collapse" aria-labelledby="faqhead4" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 4-->
                                    </div>
                                </div>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead5">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq500" aria-expanded="true" aria-controls="faq500">Course 4 - Pemeriksaan EKG</a>
                                </div>

                                <div id="faq500" class="collapse" aria-labelledby="faqhead5" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 5-->
                                    </div>
                                </div>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead6">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq600" aria-expanded="true" aria-controls="faq600">Post Test</a>
                                </div>

                                <div id="faq600" class="collapse" aria-labelledby="faqhead6" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 6-->
                                    </div>
                                </div>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead7">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq700" aria-expanded="true" aria-controls="faq700">Course 2 - Konsep Dasar EKG</a>
                                </div>

                                <div id="faq700" class="collapse" aria-labelledby="faqhead7" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 7-->
                                    </div>
                                </div>
                            ...
                            <div class="card mb-0">
                                <div class="card-header" id="faqhead8">
                                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq800" aria-expanded="true" aria-controls="faq800">Course 2 - Konsep Dasar EKG</a>
                                </div>

                                <div id="faq800" class="collapse" aria-labelledby="faqhead8" data-parent="#faq">
                                    <div class="card-body">
                                        <!-- collpase 8-->
                                    </div>
                                </div>
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="col-12 mb-4">
                    <img src="{{ asset('web/img/content-detail.png') }}" alt="">
                </div>
                <div class="col-12 mb-4">
                    <h2>Elektrodiagram Normal</h2>
                    <p>Instruktur : Mark Zukenberg | 10 jam/minggu</p>
                </div>
