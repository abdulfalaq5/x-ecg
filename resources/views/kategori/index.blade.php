<x-layout.app-admin title="{!! __('Kategori') !!}">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{!! __('Kategori') !!}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-right">
                            <a href="{{ route('master.kategori.create') }}" type="button" class="btn btn-success"
    ...
    @push('scripts')
        <script>
            ...
            var role_table = $('#tbl-data').DataTable({
                ...
                ajax: {
                    url: "{{ route('master.kategori.list') }}",
                    method: 'POST',
                    headers: {
            ...
            function deleteData(id) {
                ...
                $.ajax({
                    url: "{{ route('master.kategori.delete') }}/" + id,
                    type: 'DELETE',
