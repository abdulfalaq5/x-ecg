...
<body>
            ...
            <div class="col content-page p-5 bg-white">
                <nav aria-label="Breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Edit Topik</a></li>
                    </ol>
                </nav>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Edit Topik</h2>
                            <form action="{{ route('editor.materi.doedit') }}" id="form-data" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title_materi" id="title_materi"
                                                        value="{{ $detail_materi->title_materi }}"
                                                    ...
                                                    <input type="hidden" name="materi_id" id="materi_id"
                                                        class="form-control" placeholder=""
                                                        value="{{ $materi }}" aria-describedby="helpId">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status_materi"
                                                        id="status_materi">
                                                        <option value="">Pilih Status</option>
                                                        <option value="Publish"
                                                            {{ $detail_materi->status_materi == 'Publish' ? 'selected' : '' }}>
                                                            Publish</option>
                                                        <option value="UnPublish"
                                                            {{ $detail_materi->status_materi == 'UnPublish' ? 'selected' : '' }}>
                                                            UnPublish</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <!--<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="star_date" id="star_date"
                                                        class="form-control" placeholder=""
                                                        value="{{ $detail_materi->star_date }}"
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="des_materi" class="form-control" id="des_add">{{ $detail_materi->des_materi }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="link_video" id="link_video"
                                                        value="{{ $detail_materi->link_video }}" class="form-control"
    ...
    <script>
        $("#form-data").submit(function(e) {
            //   e.preventDefault();
            var title_materi = $("#title_materi").val();
            var status_materi = $("#status_materi").val();
            var star_date = $("#star_date").val();
            var end_date = $("#end_date").val();
            if (title_materi == '') {
                alert('Topik name must be filled in');
                e.preventDefault();
                return false;
            }

            if (status_materi == '') {
                alert('Topik status must be filled in');
                e.preventDefault();
                return false;
            }

            if (star_date == '') {
                alert('Topik star date must be filled in');
                e.preventDefault();
                return false;
            }

            if (end_date == '') {
                alert('Topik end date must be filled in');
                e.preventDefault();
                return false;
            }
