            ...
            <div class="col content-page p-5 bg-white">
                <nav aria-label="Breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Add Topik</a></li>
                    </ol>
                </nav>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Add Topik</h2>
                            <form action="{{ route('editor.course.doadd') }}" id="form-data" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="star_date" id="star_date"
