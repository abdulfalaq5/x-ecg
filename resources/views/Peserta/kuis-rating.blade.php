    ...
    <div class="container-fluid px-0">
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <!-- The Modal -->
                <div id="myModal" class="modal-passed">
                        ...
                        <div class="container mt-5">
                            <div class="row mb-5">
                                <div class="col-12 mb-4 text-center">
                                    <h2 style="color: #2fd2dc">Congrats, you have successfully completed this quiz</h2>
                                </div>
                                <div class="col-12 mb-4 text-center">
                                    <h4 style="color: #2fd2dc">Your Score</h4>
                                </div>
                                <div class="col-12 mb-3 text-center">
                                    <h1 style="color: #2fd2dc">{{ $data_nilai ?? 0 }}</h1>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-12 text-center">
                                    <a href="{{ route('peserta.mycourse') }}" type="button" class="btn btn-primary btn-lg" style="color: #000">Next Module &gt;&gt;</a>
                                </div>
                            </div>
                        </div>
                    </div>
