...
<body>
    ...
    <div class="box-payment-detail">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <h2 class="mb-3"><b>Happy Learning</b></h2>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the </p>
                        <p class="mb-3">industry's standard dummy text ever since the 1500s,</p>
                        <div class="box-image-detail w-100 d-flex justify-content-center mb-3">
                            <div class="image-detal w-25 text-center">
                                <img src="{{ asset('web/img/Group.png')}}" style="width: 100%;" alt="">
                            </div>
                        </div>
    ...
    <script>
        function register() {
            ...
            var url = "{{ route('register.index') }}" + '?' + jQuery.param(params);
