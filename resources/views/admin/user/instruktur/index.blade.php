<x-layout.app-admin title="{!! __('Instruktur') !!}">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{!! __('Instruktur') !!}</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 text-right">
                            <a href="{{ route('user.instruktur.create') }}" type="button" class="btn btn-success"
                                data-toggle="modal" data-target="#myModal">
                                Tambah {!! __('Instruktur') !!}
                            </a>
                        </div>
                    </div>
                    <br />
    ...
    <script>
        ...
        var role_table = $( '#tbl-data' ).DataTable( {
            ...
            ajax: {
                url: "{{ route('user.instruktur.list') }}",
                method: 'POST',
                headers: {
