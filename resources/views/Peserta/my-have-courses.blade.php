...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.0.0-alpha5/bootstrap-icons.css" rel="stylesheet">
...
<body>
                ...
                <div class="course-in">
                    ...
                    @endphp
                        @foreach ($data_course as $item)
                            <div class="col-12 col-md-{{$col}} col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-image d-flex">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <!--<p class="mt-3">Instruktur{{ $item->instruktur }}</p>-->
                                            <!--<div class="bar">
                    ...
                    <!--<div class="row col-6">
                        <div class="select-dropdown d-flex mt-4 ml-5 justify-content-start align-items-center">
                            <h6 class="pb-2 ml-2 mr-3">Show</h6>
                            <div class="dropdown">
                                <select class="dropdown" id="numberDropdown">
                    ...
                    <div class="row col-6 d-flex justify-content-end align-items-center">
                        <div class="btn-page ">
                            <div class="btn-group" role="group" aria-label="Arrow Button Group">
    ...
    <style>
        ...
        .card-image img {
            ...
            height: auto;
            display: block;
            /* menghindari margin bawah pada gambar */
        }
        ...
        .progress-bar {
            ...
            line-height: 30px;
            border-radius: 20px;
            /* Same as height, to center the text vertically */
            color: white;
        }
