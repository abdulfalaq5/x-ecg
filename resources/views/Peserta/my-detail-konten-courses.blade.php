            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="container mt-3">
                    <div class="container mt-3">
                        <div class="container mt-3">
                            <!-- Progress Bar -->
                            <!-- <p disable>Course 1 of 6</p>
                            <h5>Course 1 - Introduction</h5>
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="col-9">
                                    <div class="progress">
                                        <div class="progress-bar pl-3" role="progressbar" style="width: 18%"
                                            aria-valuenow="18" aria-valuemin="0" aria-valuemax="100">2 completed
                                            units of 11 available</div>
                                        <p style="padding-top: 16px; position: absolute;">2 completed units of 11
                                            available</p>
                                    </div>
                                </div>
                                <button class="btn btn-primary" type="button"
                                    onclick="location.href='#collapseThree'">Go to Section 3</button>
                            </div>-->
                            ...
                            <div id="accordion" class="mt-4">
                                ...
                                <div class="container">
                                    <div class="accordion" id="faq">
                                        ...
                                        @foreach ($data_materi as $item)
                                        <div class="card mb-0">
                                            <div class="card-header" id="faqhead2{{ $item->id }}">
                                                <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#faq101{{ $item->id }}" aria-expanded="true" aria-controls="faq101{{ $item->id }}">{{ $item->title_materi }}</a>
                                            </div>

                                            @if (!empty($data_module))
                                            @foreach ($data_module as $row)
                                            @if ($item->id == $row->materi_id)
                                            <div id="faq101{{ $row->materi_id }}" class="collapse" aria-labelledby="faqhead2{{ $row->materi_id }}" data-parent="#faq">
                                                <div class="card-body">
