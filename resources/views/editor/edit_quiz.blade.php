        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Edit Quiz</h2>
                            <form action="{{ route('editor.quiz.doedit') }}" id="form-data" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title_quiz" id="title_quiz"
                                                        class="form-control" placeholder=""
                                                        value="{{ $data_quiz->title_quiz }}"
                                                        aria-describedby="helpId">
                                                    <input type="hidden" name="quiz_id" id="quiz_id"
                                                        class="form-control" placeholder=""
                                                        value="{{ $data_quiz->id }}" aria-describedby="helpId">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="waktu_quiz" id="waktu_quiz"
                                                        class="form-control" placeholder=""
                                                        value="{{ $data_quiz->waktu_quiz }}"
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="waktu_akhir_quiz"
                                                        id="waktu_akhir_quiz" class="form-control" placeholder=""
                                                        value="{{ $data_quiz->waktu_akhir_quiz }}"
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="des_quiz" class="form-control" id="des_add">{!! $data_quiz->des_quiz !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('editor.quiz.index', [$id, $materi, $module]) }}"
