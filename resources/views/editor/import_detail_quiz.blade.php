...
<head>
    ...
    <!-- Title -->
    <title>Import Question Quiz</title>
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-header" id="faqhead{{ $item->id }}">
                                            <a href="#" class="btn btn-header-link collapsed"
                                                data-toggle="collapse" data-target="#faq100{{ $item->id }}"
                                                aria-expanded="true"
                                        ...
                                        <a type="button"
                                            ...
                                            class="btn btn-success" style="color: black">Add
                                            Module</a>
                                    </div>
                                @endforeach
                            @endif
                            <a type="button" onclick="window.location.href='{{ route('editor.course.add', $id) }}'"
                                href="{{ route('editor.course.add', $id) }}" class="btn btn-success"
                                style="color: black">Add Materi</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col content-page p-5 bg-white">
                <nav aria-label="Breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Import Question Quiz</a></li>
                    </ol>
                </nav>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Import Question Quiz</h2>
                            <p>
                                Silahkan Import data dengan menggunakan template berikut
                                <a href="{{ asset('template/template-import-quiz.xlsx') }}">Template</a>
                            </p>
                            <form action="{{ route('editor.quiz.detail.doimport') }}" id="form-data" method="POST"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="module_id" id="module_id"
                                                        class="form-control" placeholder=""
                                                        value="{{ $module }}" aria-describedby="helpId">
                                                    <input type="hidden" name="quiz_id" id="quiz_id"
                                                        class="form-control" placeholder=""
                                                        value="{{ $quiz }}" aria-describedby="helpId">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('editor.quiz.detail', [$quiz, $id, $materi, $module]) }}"
                                        type="button" class="btn btn-secondary" style="color: black">Kembali</a>
                                    <button type="submit" class="btn btn-primary" id="submit"
                                        style="color: black">Import</button>
