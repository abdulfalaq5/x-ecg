            ...
            <div class="col content-page p-5 bg-white">
                <nav aria-label="Breadcrumb" class="mb-2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Detail Section</a></li>
                    </ol>
                </nav>
                <div class="row mb-5 text-center">
                    <div class="col-2 info-active">
                        <a
                            href="{{ route('editor.module.detail', [$id, $materi, $detail_module->id]) }}">Informasi</a>
                    </div>
                    <div class="col-2">
                        <a href="{{ route('editor.konten', [$id, $materi, $detail_module->id]) }}">Konten</a>
                    </div>
                    <div class="col-2">
                        <a class=""
                            href="{{ route('editor.quiz.index', [$id, $materi, $detail_module->id]) }}">Quiz</a>
                    </div>
                </div>
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Detail Section</h2>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Title Section</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">: {{ $detail_module->title }}</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Dokumen Section</h3>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ url('/file_materi/' . $detail_module->file_materi) }}"
                                class="btn btn-primary" target="_blank" style="color: #000000">Download</a>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Deskripsi Section</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">: {{ $detail_module->des }}</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Link Meet</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">: <a href="{{ $detail_module->link_meet }}" target="_blank"
                                    rel="noopener noreferrer">Link</a></h3>
                        </div>
                        <div class="col-md-13">
                            <iframe src="{{ $detail_module->link_video }}"></iframe>
                        </div>
                    </div>
                </div>
