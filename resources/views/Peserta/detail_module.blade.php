                ...
                <div class="navbar-dark bg-white position-fixed h-100 align-self-start w-sidebar">
                    ...
                    <div class="container">
                        <div class="accordion" id="faq">
                            <label href="{{ route('home.index') }}" class="mb-0" style="padding: 15px 0 15px 18px; font-size: 16px; color: #222; width:100%">{{ $data_course->title }}</label>
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="row mb-5 text-center">
                    <div class="col-2 info-active">
                        <a href="{{ route('editor.module.detail', [$id, $materi, $detail_module->id]) }}">Informasi</a>
                    </div>
                    <div class="col-2">
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Detail Module</h2>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Title Module</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">: {{ $detail_module->title }}</h3>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Dokumen Module</h3>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ url('/file_materi/' . $detail_module->file_materi) }}" class="btn btn-primary" target="_blank" style="color: #000000">Download</a>
                        </div>
                        <div class="col-md-6">
                            <h3 class="mb-4">Deskripsi Module</h3>
                        </div>
                        <div class="col-md-6">
