        ...
        <div class="row collapse show no-gutters d-flex h-100 position-relative">
            ...
            <div class="col content-page p-5 bg-white">
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4">Form Add Quiz</h2>
                            <form action="{{ route('editor.quiz.doadd') }}" id="form-data" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="waktu_quiz" id="waktu_quiz"
                                                        class="form-control" placeholder=""
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="waktu_akhir_quiz"
