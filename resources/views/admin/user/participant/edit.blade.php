                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->name }}">

                    </div>
                    <div class="form-group">
                        <label for="">Password</label> (kosongkan jika tidak ingin merubah password)
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->email }}">

                    </div>
                    <div class="form-group">
                        <label for="">Nomor Telepon</label>
                        <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder=""
                            aria-describedby="helpId" value="{{ $data->phone_number }}">
...
<script>
    ...
    $("#form-data").submit(function(e) {
        ...
        ajax({
            url: "{{ route('user.participant.update', $data->_token) }}",
            postData: postData,
            processData: false,
            contentType: false,
            alert: false,
