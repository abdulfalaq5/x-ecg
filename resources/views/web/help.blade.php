...
<body>
    ...
    <div class="container-fluid header-search mb-5 d-flex justify-content-center align-items-center">
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="form-group has-search position-relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        style="color: black; position: absolute; right: 10px; top: 7px;">
                        <path
        ...
        <div class="accordion" id="faq">
            <div class="card mb-0">
                <div class="card-header" id="faqhead3">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq300" aria-expanded="true" aria-controls="faq300">What is Lorem Ipsum?</a>
                </div>
            ...
            <div class="card mb-0">
                <div class="card-header" id="faqhead4">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq400" aria-expanded="true" aria-controls="faq400">What is Lorem Ipsum?</a>
                </div>
            ...
            <div class="card mb-0">
                <div class="card-header" id="faqhead5">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq500" aria-expanded="true" aria-controls="faq500">What is Lorem Ipsum?</a>
                </div>
            ...
            <div class="card mb-0">
                <div class="card-header" id="faqhead6">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq600" aria-expanded="true" aria-controls="faq600">What is Lorem Ipsum?</a>
                </div>
            ...
            <div class="card mb-0">
                <div class="card-header" id="faqhead7">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq700" aria-expanded="true" aria-controls="faq700">What is Lorem Ipsum?</a>
                </div>
            ...
            <div class="card mb-0">
                <div class="card-header" id="faqhead8">
                    <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse"
                        data-target="#faq800" aria-expanded="true" aria-controls="faq800">What is Lorem Ipsum?</a>
                </div>
