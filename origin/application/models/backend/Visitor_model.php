...
class Visitor_model extends CI_Model{
	...
	function visitor_statistics(){
        $query = $this->db->query("SELECT DATE(visit_date) AS tgl,COUNT(visit_ip) AS jumlah FROM tbl_visitors WHERE MONTH(visit_date)=MONTH(CURDATE()) GROUP BY DATE(visit_date)");
